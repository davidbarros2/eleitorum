...
### 3.5. UMinho affiliation disclaimer

The application is **not officially affiliated with, endorsed by, or developed on
behalf of Universidade do Minho**. It is an independent open-source utility
created to assist a member of the UMinho community. The README and About dialog
must include a clearly worded disclaimer to this effect, in both Portuguese and
(for the README) English.

Suggested wording (PT, About dialog):
